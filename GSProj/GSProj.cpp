...
int InLogFunc() {
	...
	string openMeth = "K:\\GSMGMT\\projects\\mgmtplat\\gsterminal\\usrfiles\\" + *loginPoint;
...
void Verify() {
	...
	string methodOpen = "K:\\GSMGMT\\projects\\mgmtplat\\gsterminal\\usrfiles\\" + *initPoint;
...
void MakeUser() {
	...
	if (Admin.newUser != "new") {
		...
		string openMethod = "K:\\GSMGMT\\projects\\mgmtplat\\gsterminal\\usrfiles\\" + *filePointer;
